...
;
;=========================Features===========================
;-Every unit command and everything from the building menu can be assigned to any key. A complete list of possible keys can be found in the links section below.
...
;-Keep the keybinds and settings after updating.
;
;==========================Links=============================
...
if StrReplace(whr.ResponseText, "`n", "") != ScriptVersion
{
	result := msgbox("A new Version is availiable. Do you want to download the new Version now?", "AWBW Advanced Hotkeys", "YesNo")
	if result = "yes"
	{
		Download "https://raw.githubusercontent.com/Incinerate93/AWBW-Advanced-Hotkeys/refs/heads/main/Awbw Advanced Hotkeys v" StrReplace(whr.ResponseText, "`n", "") ".ahk", A_ScriptDir "\AWBW Advanced Hotkeys v" StrReplace(whr.ResponseText, "`n", "") ".ahk"
		if FileGetSize(A_ScriptDir "\AWBW Advanced Hotkeys v" StrReplace(whr.ResponseText, "`n", "") ".ahk") > 100000
		{
			msgbox "The new version has been downloaded successfully. The script will reload now.", "AWBW Advanced Hotkeys"
			Run A_ScriptDir "\AWBW Advanced Hotkeys v" StrReplace(whr.ResponseText, "`n", "") ".ahk"
			ExitApp
		}
		else
